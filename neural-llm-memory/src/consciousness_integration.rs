...
mod tests {
    ...
    #[test]
    fn test_optimized_consciousness_creation() {
    ...
    fn test_optimized_processing() {
        ...
        let output1 = consciousness.process_optimized(input.clone());
        assert!(output1.consciousness_level >= 0.0);
        
        // Second call - potential cache hit
        let output2 = consciousness.process_optimized(input);
        assert!(output2.consciousness_level >= 0.0);
    ...
    fn test_batch_processing() {
        ...
        let inputs: Vec<ConsciousInput> = (0..10)
    ...
    fn test_performance_validation() {
        ...
        // Should meet targets with optimizations enabled
        assert!(validation.latency_target_met);
        assert_eq!(validation.overall_status, validation.latency_target_met && 
                   validation.cache_performance_ok && validation.efficiency_score_ok);
    }
    ...
    fn test_cache_efficiency() {
        ...
        // Process same input multiple times for cache hits
        let input = ConsciousInput {
            content_type: ContentType::PerceptualInput,
            activation: 0.8,
            attention_weight: 0.7,
        ...
        for _ in 0..50 {
            consciousness.process_optimized(input.clone());
        }
        
        let efficiency = consciousness.cache_efficiency();
        assert!(efficiency > 0.5); // Should have good efficiency with repeated inputs
    }
}